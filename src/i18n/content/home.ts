...
const ar: HomeContent = {
  ...
  heroTitle: 'أبني الطبقة التي تقع بين نموذج لغوي وبرمجيات قائمة بالفعل.',
  heroProse:
    'أكثر من خمس سنوات مع السؤال العنيد نفسه: كيف تأخذ شيئًا يعمل في دفتر ملاحظات وتجعله ينجو ' +
    'أمام مستخدمين حقيقيين؟ في معظم الوقت كان ذلك يعني أنظمة الخلفية، وتعلّم الآلة في الإنتاج، ' +
    'وطبقة التحكّم بينهما. ومؤخرًا دخل خيط رابع: تعلّم الآلة من أجل علم الأحياء، حيث البيانات ' +
    'قليلة، والتسميات مشوّشة، والصدق في أرقامك أهمّ من تصدّر لوحة النتائج.',
  ctaWriting: 'اقرأ المقالات',
  ctaProjects: 'شاهد المشاريع',
  portraitAlt: 'شمس الدين أحمد، صورة في دكا',
  sectionNow: 'الآن',
  sectionThreads: 'ما أفكّر فيه',
  sectionRecent: 'أحدث المقالات',
  allPosts: (label) => `كل المقالات: ${label}`,
  seriesLink: (label) => label,
  now: [
    {
      ...
      when: 'منذ أغسطس ٢٠٢٦',
      what:
        'منصّة لتجربة العملاء مدفوعة بالذكاء الاصطناعي، يستخدمها مشغّلو اتصالات ومئات من الشركات ' +
        'الأصغر. أعمل على جانب الذكاء الاصطناعي: الوكلاء، والاسترجاع، وبنية التشغيل تحتهما.',
    },
    {
      role: 'مؤسِّس',
      org: 'AlgolyzerLab',
      ...
      when: 'منذ ٢٠٢٤',
      what:
        'استوديو صغير للذكاء الاصطناعي التطبيقي، للعمل الذي لا تتّسع له خطّة منتج: علوم رياضة ' +
        'لكريكت النخبة، وبرمجيات إكلينيكية للأطباء، وذكاء اصطناعي للزراعة، وهندسة بحثية.',
    },
  ],
  threads: [
    {
      n: '٠١',
      title: 'طبقة التحكّم بالوكلاء',
      body:
        'النموذج نافع بقدر السطح الذي تسلّمه له. معظم الفرق تعطي النموذج جداول خامًا ومواصفات ' +
        'مولّدة، بدلًا من العمليات المسمّاة بالمعنى التي يملكها كودها أصلًا.',
      links: [
        { label: 'Reins', href: LINKS.reins },
        { label: 'Veldra', href: LINKS.veldra },
        { label: 'السلسلة', href: '/series/agent-harness/' },
      ],
    },
    {
      n: '٠٢',
      title: 'تعلّم الآلة لعلم الأحياء',
      body:
        'التنبؤ بالببتيدات المضادة للالتهاب، والفرز الافتراضي الواعي للبنية لمنتجات طبيعية ضدّ ' +
        'بروتييزات فيروسية قليلة الدراسة. علّمني الاثنان الدرس نفسه: البيانات التي تختارها تحدّد ' +
        'النتيجة قبل أن يحدّدها النموذج بوقت طويل.',
      links: [
        { label: 'DeepNatProtease', href: LINKS.deepnat },
        { label: 'السلسلة', href: '/series/machine-learning-for-biology/' },
      ],
    },
    {
      n: '٠٣',
      title: 'أنظمة تبقى قابلة للتفسير',
      body:
        'أدوات صغيرة، قابلة للقراءة، بلا سحر، أستخدمها فعلًا: ضغط صور إدراكي، ومراقب نظام في ' +
        'الطرفية، وأسراب وكلاء بنموذج الفاعل. ملفات تنفيذية واحدة، بلا إطار عمل تحتها.',
      links: [
        { label: 'Fennec', href: LINKS.fennec },
        { label: 'VoidMon', href: LINKS.voidmon },
        { label: 'Clawkido', href: LINKS.clawkido },
...
export const HOME: Record<Locale, HomeContent> = { en, bn, ar };
