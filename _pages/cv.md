...
research interests in computational biology, covering anti-inflammatory peptide prediction and
...
* The core contribution is a dataset correction. Prior work draws negatives from random UniProt
  proteins, which quietly turns the task into "short peptide vs. long protein". Drawing
  experimentally validated negatives from the same **IEDB** T-cell assays as the positives
  produces a harder benchmark, and more honest numbers.

**AI-Driven Discovery of Natural-Product Inhibitors of Viral Proteases**
*(DeepNatProtease, ongoing)*
...
* Screens the **COCONUT** natural-products library (>400k compounds), filters for
  ...
  protease structures, then prioritizes candidates by consensus of ML probability, docking
  score, and drug-likeness.
