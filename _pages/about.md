...
excerpt: "Senior Software Engineer working on agent harnesses, LLM infrastructure, and machine learning for biology."
author_profile: true
redirect_from:
  - /about/
  - /about.html
...
where an agent is stored as *data*, a versioned spec row, rather than as code.

**Machine learning for biology.** I work on anti-inflammatory peptide prediction, and on
structure-aware virtual screening of natural products against understudied viral proteases
...
monitor), and [Clawkido](https://github.com/shamspias/clawkido) (actor-model agent swarms).
Small, readable, zero-magic tools I actually use.
